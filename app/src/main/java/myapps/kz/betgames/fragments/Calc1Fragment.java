...
public class Calc1Fragment extends Fragment {
    ...
    private void getSettingValues() {
        ...
        val_last_profit = preferences.getLong("val_last_profit", -1);
        val_last_coef = Double.longBitsToDouble(preferences.getLong("val_last_coef", Double.doubleToLongBits(-1)));
        val_total_spent = preferences.getLong("val_total_spent", -1);
    }
        ...
        editProfit.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!editProfitText.isEmpty()) {
                    ...
                    editor.putLong("val_last_profit", val_last_profit);
                    editor.apply();
                    changeAmountValue();
                }
            }
        ...
        editCoef.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!editCoefText.isEmpty()) {
                    ...
                    editor.putLong("val_last_coef", Double.doubleToRawLongBits(val_last_coef));
                    editor.apply();
                    changeAmountValue();
                }
            }
    ...
    public void updateList() {
        ...
        if (jsonBets.isEmpty()) {
            ...
            editor.putLong("val_total_spent", val_total_spent);
            textTotalSpent.setText("Общий расход: " + String.valueOf(val_total_spent));
            ...
            editor.putString("json_bets", jsonBets);
            editor.apply();
        } else {
